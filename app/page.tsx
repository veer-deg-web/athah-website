      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-xl items-center">
        <div className="stagger-item">
          ...
          <p className="text-body-lg text-on-surface-variant mb-md">
            ...
            reliable creative partner, Athah Art Entertainment is based in Dehradun
            and serves schools, institutions, and cultural ecosystems across India.
          </p>
          <p className="text-body-md text-on-surface-variant mb-lg">
            ...
            faculty, zero management stress, and structured backup always in place.
          </p>
          <Link
            href="/about"
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-xl items-center">
          ...
          <div className="stagger-item">
            ...
            <ul className="space-y-md">
              {[
                { icon: "movie", title: "4K Multi-Cam Shoots", desc: "Full broadcast-quality productions for every scale" },
                { icon: "flight_takeoff", title: "Aerial Drone Coverage", desc: "Breathtaking perspectives from the sky" },
                { icon: "edit_square", title: "Same-Day Edits", desc: "Reels delivered while your event is still trending" },
              ].map((item) => (
...
function WhyAthahSection() {
  const reasons = [
    { icon: "verified", title: "One Partner, Every Need", desc: "Dance, music, theatre, fine art, events, media — one trusted partner manages it all." },
    { icon: "swap_horiz", title: "Backup & Replacement Guarantee", desc: "Not satisfied with an artist? We replace immediately. No management stress for schools." },
    { icon: "school", title: "School & Institution Specialists", desc: "Specialists in educational events, arts faculty staffing, and cultural program production." },
    { icon: "visibility", title: "Making Student Work Visible", desc: "Children practice every day but parents never see the effort. Athah captures and shares it." },
    { icon: "photo_camera", title: "School-Safe Content Creation", desc: "Parent-friendly reels, activity photos, and highlights — school-approved and professionally crafted." },
    { icon: "currency_rupee", title: "Affordable & Transparent Pricing", desc: "Monthly activity teachers from ₹15,000. Cultural events from ₹1.5L. No hidden costs." },
  ];
...
function TestimonialsSection() {
  const testimonials = [
    {
      quote: "Athah transformed our annual function. The choreography, lighting, and costumes were spectacular — and the entire process was stress-free for our team.",
      name: "Principal",
      role: "Arihant International School, Nahan",
    },
    {
      quote: "Finding reliable activity teachers was always a challenge. Since partnering with Athah, our dance and music programs run seamlessly every single week.",
      name: "Head of Activities",
      role: "Tula's Institute, Dehradun",
    },
    {
      quote: "Parents can now see their children's daily progress through the reels and photos Athah creates. School trust and admissions interest have both improved.",
      name: "Director",
...
function PartnersSection() {
  const partners = [
    "Arihant International School", "Tula's Dehradun", "Delhi Public School", "River Valley Global School",
    "Swami Vivekanand Public School", "RIT", "Lal Manjan Studio", "athah_events",
  ];
